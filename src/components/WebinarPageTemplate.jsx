...
//   // Rest of the existing functions (getAllWebinars, getTnpWebinars, getEcWebinars, etc.)
...
//   // Updated Selected Webinar component
...
const WebinarPage = ({ tnpWebinars, ecWebinars }) => {
  ...
  // Check if a webinar is from the EC category
